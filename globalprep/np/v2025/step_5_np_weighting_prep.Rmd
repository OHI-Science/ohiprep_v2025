...
summary(harvest_tonnes_usd_geo_rgn)
...
```{r}
# Combine value data with commodity data
# Ornamentals
# orn_val <- orn %>% 
#   left_join(harvest_tonnes_usd, by = join_by(rgn_id, rgn_name, product, year, tonnes)) %>% 
#   view()
# # Tonnes were identical here so we can join by them
# # setdiff(orn_val$tonnes.x, orn_val$tonnes.y)
# 
# # Seaweed
# seaweed_val <- seaweed %>% 
#   left_join(harvest_tonnes_usd, by = join_by(rgn_id, product, year)) %>% 
#   view()
# # Tonnes are NOT identical because we're using FAO data
# setdiff(seaweed_val$tonnes.x, seaweed_val$tonnes.y)
# 
# # FOFM data
# fofm_val <- fofm %>% 
#   left_join(harvest_tonnes_usd, by = join_by(rgn_id, product, year)) %>% 
