...
spain <- mar_sustainability_score %>% 
  filter(rgn_id == 182) %>% 
  view()

colSums(is.na(spain)) # 0
nrow(spain) # 146
...
setdiff(spain_24$sust_coeff, spain_25$sust_coeff) # numeric(0)
setdiff(spain_25$sust_coeff, spain_24$sust_coeff) # numeric(0)


# Compare to the original 2024 data
sust_old <- readr::read_csv(here::here("globalprep", "mar", "v2024",
...
spain_old <- sust_old %>% 
  filter(rgn_id == 182) %>% view()

setdiff(spain_24$sust_coeff, spain_old$sust_old) 
# [1] 0.8961039 0.9090909
