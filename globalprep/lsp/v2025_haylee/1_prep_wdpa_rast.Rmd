...
shp_reorder_0 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_0')
...
shp_reorder_1 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_1') # replace month and year with the appropriate month and year
shp_reorder_2 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_2') # replace month and year with the appropriate month and year
...
gc()
```
**Note** Change file paths for output geospatial files here.
...
shp_reorder_0 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_0')
shp_reorder_1 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_1')
shp_reorder_2 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_2')
...
shp_xformed_0 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_xformed_0') # replace month and year with the appropriate month and year
shp_xformed_1 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_xformed_1') # replace month and year with the appropriate month and year
shp_xformed_2 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_xformed_2') # replace month and year with the appropriate month and year
...
rast_wdpa_file <- file.path(dir_goal_anx,
                            'rast',
                            'haylee_wdpa_2025_moll_500m.tif') 
...
if(!file.exists(rast_wdpa_file)) {
  ...
  # replace month and year with the appropriate month and year
  shp_xformed_file_0 <- file.path(dir_data, 'shps_ho',
  ...
  shp_xformed_file_1 <- file.path(dir_data, 'shps_ho',
                                  'WDPA_Jun2025_shp_xformed_1',
                                  'WDPA_Jun2025_shp_xformed_1.shp') 
  shp_xformed_file_2 <- file.path(dir_data, 'shps_ho',
...
# years = values(check_current)

check_current_abs <- ifel(is.na(check_current), 0, 1)
plot(check_current_abs)
...
Some new large blobs off the Northwestern coast of Australia. Various other smaller changes. On the whole, it looks like slightly more area this year compared to last year, just eye-balling things. 
...
```{r}
# Had an error reading in the previous years data. Decided to simplify it for troubleshooting
