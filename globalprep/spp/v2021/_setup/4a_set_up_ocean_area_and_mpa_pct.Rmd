...
wdpa_marine_file <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2021/wdpa_mar_by_cat_Feb2021_500m.tif')
wdpa_poly_file_0   <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2021/WDPA_WDOECM_wdpa_shp/WDPA_WDOECM_wdpa_shp0', 
                              'WDPA_WDOECM_wdpa_shp-polygons.shp')
wdpa_poly_file_1   <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2021/WDPA_WDOECM_wdpa_shp/WDPA_WDOECM_wdpa_shp1', 
                              'WDPA_WDOECM_wdpa_shp-polygons.shp')
wdpa_poly_file_2   <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2021/WDPA_WDOECM_wdpa_shp/WDPA_WDOECM_wdpa_shp2', 
                              'WDPA_WDOECM_wdpa_shp-polygons.shp')
...
if(!file.exists(wdpa_marine_file)) {
  ...
  #plot(raster(file.path(dir_raw_data_anx, 'wdpa_mpa/d2020/wdpa_mar_by_cat_Apr2020_500m.tif')))
...
wdpa_prot_yr_file <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2021', 
                               'wdpa_mar_by_prot_yr_Feb2021_500m.tif')
...
# 5335.773  588.892  550.586  - about ten minutes! 
  ...
  # ## splitting it by 10s... see if this will work if doing all the chunks at once wont... 
  # wdpa_cells_list_1_10 <- wdpa_cells_list
  # wdpa_cells_list_11_20 <- wdpa_cells_list
  # wdpa_cells_list_21_30 <- wdpa_cells_list
  # wdpa_cells_list_31_40 <- wdpa_cells_list
  # wdpa_cells_list_41_50 <- wdpa_cells_list
  # wdpa_cells_list_51_60 <- wdpa_cells_list
  # 
  # 
  # wdpa_cells_df <- bind_rows(wdpa_cells_list_1_10, wdpa_cells_list_11_20, wdpa_cells_list_21_30, wdpa_cells_list_31_40, wdpa_cells_list_41_50, wdpa_cells_list_51_60)
...
## split it into 10s if the full chunk doesnt work... 
  # wdpa_cells_list_1_10 <- wdpa_cells_list
  # wdpa_cells_list_11_20 <- wdpa_cells_list
  # wdpa_cells_list_21_30 <- wdpa_cells_list
  # wdpa_cells_list_31_40 <- wdpa_cells_list
