...
vgpm.raster = function(file, w.lon, e.lon, n.lat, s.lat, log = TRUE, 
  ...
  writeRaster(r,filename=paste0(file.path(dir_M,'git-annex/globalprep/prs_fish/v2020/VGPM_primary_productivity/int/rasterized_rawdata/'),'npp',sep='_',strftime(day1,'%B %Y')),
