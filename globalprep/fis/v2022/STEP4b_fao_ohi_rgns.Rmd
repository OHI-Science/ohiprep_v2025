---
title: "OHI 2022: Food Provision/Fisheries, Identify FAO and OHI regions for RAM stocks"
...
We didn't need to update this because the RAM data did not change for v2022.
...
RAM_na_non_multi <- RAM_nas %>%
  ...
  mutate(fao_id = as.double(fao_id)) # great, this only leaves 20 stocks that we need to fill in now! 
...
# we have three larger areas that require manual data entry
