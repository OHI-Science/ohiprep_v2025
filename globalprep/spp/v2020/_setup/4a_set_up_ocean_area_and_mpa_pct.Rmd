...
if(!file.exists(wdpa_marine_file)) {
  ...
  wdpa_poly <- sf::st_read(wdpa_poly_file)
  ...
  #plot(raster(file.path(dir_raw_data_anx, 'wdpa_mpa/d2019/wdpa_mar_by_cat_Apr2019_500m.tif')))
...
wdpa_prot_yr_file <- file.path(dir_raw_data_anx, 'wdpa_mpa/d2020', 
                               'wdpa_mar_by_prot_yr_Apr2020_500m.tif')
...
if(!file.exists(wdpa_prot_yr_file)) {
  ...
  #plot(raster(file.path(dir_raw_data_anx, 'wdpa_mpa/d2019/wdpa_mar_by_prot_yr_Apr2019_500m.tif')))
