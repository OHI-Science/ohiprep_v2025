---
title: 'OHI 2021: Lasting Special Places'
...
rast_wdpa <- raster::raster(file.path(dir_goal_anx, 'rast', 'wdpa_2021_moll_500m.tif'))
...
status_3nm_old <- read_csv(file.path(dir_goal, '../v2020/output', 'lsp_prot_area_offshore3nm.csv')) %>%
  full_join(read_csv(file.path(dir_goal, 'output', 'rgn_area_offshore3nm.csv')),
            by = 'rgn_id') %>%
...
status_1km_old <- read_csv(file.path(dir_goal, '../v2020/output', 'lsp_prot_area_inland1km.csv')) %>%
  full_join(read_csv(file.path(dir_goal, 'output', 'rgn_area_inland1km.csv')),
            by = 'rgn_id') %>%
