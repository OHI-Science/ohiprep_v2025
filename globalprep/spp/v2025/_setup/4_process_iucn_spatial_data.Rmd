...
This may *over* predict range for many species whose range is limited by depth, due to polygon buffering.  This can be used to sanity-check the raster-calculated ranges.
