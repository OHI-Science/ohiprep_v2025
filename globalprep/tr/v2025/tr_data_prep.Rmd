...
ttdi_raw <- pdf_text(here::here(raw_data_dir, "WEF-Economics", current_data_dir, ttdi_file)) # using the package `pdftools`, read in using pdf_text()
...
ap_gf <- read_csv(here(current_tr_dir, "out", "tr_arrivals_props_tourism.csv")) %>%
  # filter(year == 2021) %>%
...
# write_csv(tr_sust_gf, here(current_tr_dir, "out", "tr_sustainability_gf.csv"))
```
...
# write_csv(tr_sust_final, here(current_tr_dir, "out", "tr_sustainability.csv"))
```