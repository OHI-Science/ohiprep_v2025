...
data_years <- c("1996", "2023") # update to correct data years
...
# Step 1: Define the indicator dictionary
# ind_dict <- list(
#   "Voice_and_Accountability" = "Voice and Accountability: Estimate",
...
# Step 3: Download data and store in list
indicator_data <- list()
...
# Step 4: Join all indicator dataframes
...
```{r}
wgi_raw <- read_csv(here::here(current_wgi_dir, "v2025", "P_Data_Extract_From_Worldwide_Governance_Indicators_2025"))
...
d <- read_csv(here(current_wgi_dir, "raw", "worldbank_wgi_from_api_2025.csv"))
colnames(d)
```
...
countries_no_data # 61 countries... a lot compared to 2024
