...
included_maps <- marine_map_info %>%
  ...
  mutate(kingdom = tools::toTitleCase(tolower(kingdom_name)),
         phylum  = tools::toTitleCase(tolower(phylum_name)),
         order   = tools::toTitleCase(tolower(order_name)),
         class   = tools::toTitleCase(tolower(class_name)),
         family  = tools::toTitleCase(tolower(family_name)))
