...
rgn_assess <- rgn_assess %>%
  filter(identifier != 'global') #why is the person gulf gone from this assessment?
...
###The created file, iucn_risk_ts_rgn_2019-1.csv is empty. This is okay. Checked the corresponding 2018 file and it is also empty...
