...
```{r}
# colSums(is.na(mar_rgn_agg))
# Save intermediate file for 2025 analysis
readr::write_csv(mar_rgn_agg, here(current_mar_dir, "int", "int_mar.csv"))
```
...
mar_rgn_spread_old <- tidyr::pivot_wider(mar_rgn_agg_old,
                                     names_from = year,
                                     values_from = value)
view(mar_rgn_spread_old)
