...
or here: [ftp://yourlogin\@ftp-access.aviso.altimetry.fr/climatology](ftp://yourlogin@ftp-access.aviso.altimetry.fr/climatology){.uri}
...
userpasswd <- readline("madisonenda%40gmail.com:EIpGkc")
```

Define file paths for data download:

```{r download_data, eval=FALSE}
year <- 2024 # data year to download; lags by 2 years. 2023 goes to May as of now, and we need a full year's worth of data for v2024
