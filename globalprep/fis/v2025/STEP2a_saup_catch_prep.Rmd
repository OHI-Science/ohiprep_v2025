---
title: "OHI `r format(Sys.Date(), '%Y')`: Food Provision, Preparing catch data for BBmsy calculations and mean catch (weights in FIS model) and FP weights"
...
- None. This script wasn't run in v2025. Associated data files within the repo were copied from v2024 to v2025.
