...
[TARAKENZ?](https://www.fishsource.org/stock_page/1911)
[TARAKSA](https://www.fishsource.org/stock_page/1912)
[gurnard](https://www.fishsource.org/stock_page/2662)
...
RAM_na_non_multi <- RAM_nas %>%
  ...
  mutate(fao_id = as.double(fao_id)) # v2025: none are multinational, so we will need to manually research all 4 stocks! 
