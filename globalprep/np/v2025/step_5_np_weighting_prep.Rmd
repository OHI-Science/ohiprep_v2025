...
harvest_tonnes_usd_values_gf <- harvest_tonnes_usd_geo_rgn %>%
  ...
  #                                       ifelse(is.na(usd_per_tonne) & georgn_usd_per_tonne == "NaN",
  #                                              "global", "none"))) %>%
  # mutate(values_gf = ifelse(is.na(usd_per_tonne) & georgn_usd_per_tonne != "NaN", 1,
  #                           ifelse(is.na(usd_per_tonne) & georgn_usd_per_tonne == "NaN", 1, 0)))
