...
This process is accomplished in `1_set_up_iucn_risk.Rmd` and `2_set_up_iucn_risk_regional.Rmd`.  Resulting timeseries of historical assessments are available in `data/iucn_risk_timeseries_2020-1.csv` and `data/iucn_risk_ts_rgn_2020-1.csv` (or with updated version numbers as applicable).
...
if(!file.exists(trends_file)) {
  ...
  for(i in c(2016:nrow(spp_ids_valid))) { # i <- 1
...
# -0.59910 -0.00326  0.00090  0.00325  0.19674 
# 
# Coefficients:
#               Estimate Std. Error t value Pr(>|t|)    
# (Intercept) -0.0008992  0.0007428  -1.211    0.226    
# pop_trend   -0.0041559  0.0009013  -4.611  4.4e-06 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.02279 on 1304 degrees of freedom
#   (851 observations deleted due to missingness)
# Multiple R-squared:  0.01604,	Adjusted R-squared:  0.01529 
# F-statistic: 21.26 on 1 and 1304 DF,  p-value: 4.403e-06
...
# Residuals:
#      Min       1Q   Median       3Q      Max 
# -0.59889 -0.00304  0.00111  0.00111  0.19696 
# 
# Coefficients:
#               Estimate Std. Error t value Pr(>|t|)    
# (Intercept) -0.0011080  0.0008077  -1.372     0.17    
# pop_trend   -0.0041456  0.0009882  -4.195 2.92e-05 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.02426 on 1230 degrees of freedom
#   (772 observations deleted due to missingness)
# Multiple R-squared:  0.01411,	Adjusted R-squared:  0.01331 
# F-statistic:  17.6 on 1 and 1230 DF,  p-value: 2.922e-05
