---
title: "OHI 2021: Food Provision, Calculating fisheries stock status"
...
```{r}
cmsy_fits <- readRDS(file.path(dir_M,"git-annex/globalprep/fis/v2021/int/cmsy-fits.rds"))
