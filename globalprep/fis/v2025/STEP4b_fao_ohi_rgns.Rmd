...
RAM_rgns_old_filt <- RAM_rgns_old %>%
  filter(!(stockid %in% unused_stocks)) # v2024: changed so it does not overwrite RAM_rgns_old
```
...
# Not super sure about this one, had a hard time finding the sub-antarctic but did find one for western australia. 
# "TARAKSA" Tarakihi Sub-Antarctic
