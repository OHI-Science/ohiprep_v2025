...
*Note, the above link did not work in the 2025 assessment. Data needed to be downloaded from fishstatj. Instructions can be found on the mazu server in the d2025 directory.*
...
# for (f in files) {
  ...
  sum(str_detect(m$commodity, "seaweed"))
  length(str_detect(m$commodity, "seaweed"))
