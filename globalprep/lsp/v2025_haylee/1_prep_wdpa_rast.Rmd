...
check_past <- terra::rast(file.path("/home/shares/ohi/git-annex/globalprep/lsp/v2023/rast/wdpa_2024_moll_500m.tif"))
...
shp_reorder_23_0 <- file.path('/home/shares/ohi/git-annex/globalprep/_raw_data/wdpa_mpa/d2024/WDPA_May2024_Public_shp/shps/WDPA_May2024_shp_ordered_0')
shp_reorder_23_1 <- file.path('/home/shares/ohi/git-annex/globalprep/_raw_data/wdpa_mpa/d2024/WDPA_May2024_Public_shp/shps/WDPA_May2024_shp_ordered_0')
shp_reorder_23_2 <- file.path('/home/shares/ohi/git-annex/globalprep/_raw_data/wdpa_mpa/d2024/WDPA_May2024_Public_shp/shps/WDPA_May2024_shp_ordered_0')
...
shp_reorder_0 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_0') # we used May data in the 2024 update... sorry it's not as easy of a fix as the previous years where you could just change the last number!
shp_reorder_1 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_1')
shp_reorder_2 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_2')
