...
prev_scen_year <- as.character(scen_year_number - 1)
data_dir_year <- paste0("d", scen_year)
prev_data_dir_year <- paste0("d", prev_scen_year, "_new")
v_scen_year <- paste0("v", scen_year, "_new")
prev_v_scen_year <- paste0("v", prev_scen_year, "_new")
...
comp_plot_1 <- ggplot() + 
  ...
  labs(x = paste("Previous Value", previous_data_year),
       ...
       title = paste0(scen_year_number, " (",latest_data_year, " data) vs. ", prev_scen_year, " (",previous_data_year, " data)", " All Countries")) +
...
comp_plot_2 <- ggplot() + 
  geom_jitter(data = total_2, aes(x = old_sust_tonnes, y = sust_tonnes, text = paste("Product:", product, "<br>Region:", rgn_id)), alpha = 0.7) +
  labs(x = paste("Previous Value", previous_data_year), 
       y = paste("Current Value", previous_data_year),
       title = paste(previous_data_year, "data", prev_scen_year, "assessment vs.", previous_data_year, "data", scen_year_number, "assessment")) +
  geom_abline(slope = 1, intercept = 0, col = "red") +
