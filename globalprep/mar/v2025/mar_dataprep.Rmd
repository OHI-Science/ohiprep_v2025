...
# We have duplicates here because when we pivoted longer, we had all the data in both 2024 and 2025. So essentially, we need to cut the length of the data frame in half. 
