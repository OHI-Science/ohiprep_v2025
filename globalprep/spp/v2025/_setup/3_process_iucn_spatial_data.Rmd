...
Rasterize each species to a 10 km x 10 km raster, saved to the git-annex `spp-rasters` folder.

For comprehensively-assessed and non-comprehensively-assessed species, calculate the following by cell, saved to the git-annex `taxa-summaries` folder:

- mean extinction risk
- variance of extinction risk
- trend
...
# Rast_base for cell IDs (import from v2025 unless updated)
rast_base <- raster('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_spatial/cell_id_rast.tif')
...
# These will be used as masks (import from v2025 unless updated)
rast_bathy <- raster('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_spatial/bathy_rast.tif')
rast_neritic <- raster('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_spatial/bathy_rast_neritic.tif')
rast_shallow <- raster('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_spatial/bathy_rast_shallow.tif')
...
# Raster for cell IDs (import from v2025 unless updated)
rast_cell_ids <- terra::rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_spatial/cell_id_rast.tif')
...
For `1a_biodiversity_maps_comp_assessed.Rmd`.
...
For `1c_biodiversity_maps_all_spp.Rmd`.

Could potentially be skipped to save time. You will need this data to analyze in `1c_biodiversity_maps_all_spp.Rmd` and to run the comparison in `spp_data_prep.Rmd`.
