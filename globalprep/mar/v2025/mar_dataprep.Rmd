...
maric_comb <- full_join(maric, maric_old, by = join_by(rgn_id, species, year))

# Clean names
maric_comb <- maric_comb %>% 
  select(rgn_id, species, year, fao25 = fao.x, fao24 = fao.y, 
         environment = environment.x, value_25 = value.x, 
         taxon_code25 = Taxon_code.x, taxon_code24 = Taxon_code.y, 
         family = family.x, gap_0_fill25 = gap_0_fill.x, 
