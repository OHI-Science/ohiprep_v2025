...
fis_revenue <- read_csv(here("globalprep", "le", "v2023", "int", "cf_revenue.csv"))
```
...
species_key <- read_csv(file.path(data_path, "int", "species-key.csv")) %>%
...
# v2025: 7% of observations still have NAS
