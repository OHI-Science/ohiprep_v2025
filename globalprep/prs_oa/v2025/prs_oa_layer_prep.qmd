...
This layer is a revamped version of previous years', and can be updated in future years now.
In the future, I would finish updating the script by changing certain `raster::calc` and `raster::stack` functions (etc) to the `terra` package.
...
-   v2025: Link to data layer is <https://data.marine.copernicus.eu/product/MULTIOBS_GLO_BIO_CARBON_SURFACE_MYNRT_015_008/download>
...
# Create 4-year rolling average for scores: 
