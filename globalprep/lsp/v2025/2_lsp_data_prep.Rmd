...
# 2192.728 ~ 35 minutes
write_csv(x, '/home/shares/ohi/git-annex/globalprep/lsp/v2025/int/zonal_stats_3nm.csv')

y <- lsp_crosstab(rgn_rast_list[2], rast_values = rast_wdpa) #35 minutes to run #1km
cat('writeRaster elapsed: ', (proc.time() - ptm)[3])
# 4283.705 ~ 1hr 10 minutes
write_csv(y, '/home/shares/ohi/git-annex/globalprep/lsp/v2025/int/zonal_stats_1km.csv')

z <- lsp_crosstab(rgn_rast_list[3], rast_values = rast_wdpa) #~51 min minutes to run #eez
cat('writeRaster elapsed: ', (proc.time() - ptm)[3])
# 7391.148 ~ 2 hours
write_csv(z, '/home/shares/ohi/git-annex/globalprep/lsp/v2025/int/zonal_stats_eez.csv')
...
write.csv(mjr_score_change, file.path(dir_goal, 'figs/major_changes_2025.csv'))
```
