...
tonnes <- read_csv(here("globalprep/np/v2025/int/tonnes.csv"))
usd <- read_csv(here("globalprep/np/v2025/int/usd.csv"))
filter(usd, rgn_id==135 & year == 2020:2023) %>% data.frame()
```
