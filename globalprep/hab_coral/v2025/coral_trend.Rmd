...
```{r, eval = FALSE}
# Read in the data
old_trend <- read.csv(file.path(here("globalprep/hab_coral/v2021/data/habitat_trend_coral_updated.csv")))
trend <- read.csv(file.path(here("globalprep/hab_coral/v2025/data/habitat_trend_coral_updated.csv")))
