...
colSums(is.na(dom_acc_guests_gf1))
...
inland_filepath <- here::here("globalprep", "lsp", version_year, "int", "rgn_area_inland1km.csv")
inland_data <- read_csv(inland_filepath)
offshore_filepath <- here::here("globalprep", "lsp", version_year, "int", "rgn_area_offshore3nm.csv")
