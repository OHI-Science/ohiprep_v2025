...
For **comprehensively-assessed** *and* **non-comprehensively-assessed** species:

Aggregate mean risk and variance by cell, saved to the git-annex: `cell_summary_unweighted_all.csv`

Create the following maps, saved to the `_output` folder:

- Mean risk: `mean_risk_raster_all.tif`
- Variance of risk: `var_risk_raster_all.tif`
- Number of species for mean/var calculations: `n_spp_risk_raster_all.tif`
- Number of species categorized as "threatened" (i.e. VU, EN, CR): `n_threat_raster_all.tif`
- Mean trend: `trend_raster_all.tif`
- Number of species for trend calculations: `n_trend_raster_all.tif`
...
### Spatial: `mean_risk_raster_all.tif`
...
```{r}
mean_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/mean_risk_raster_all.tif')

mean_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/mean_risk_raster_all.tif')
...
plot(mean_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "Mean New- All (2025)")
plot(mean_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "Mean Old- All (2024)")
```

### Output: `var_risk_raster_all.tif`
...
```{r}
var_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/var_risk_raster_all.tif')

var_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/var_risk_raster_all.tif')
...
plot(var_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "Variance New- All (2025)")
plot(var_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "Variance Old- All (2024)")
```

### Output: `n_spp_risk_raster_all.tif`
...
```{r}
n_spp_risk_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/n_spp_risk_raster_all.tif')

n_spp_risk_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/n_spp_risk_raster_all.tif')
...
plot(n_spp_risk_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Spp Risk New- All (2025)")
plot(n_spp_risk_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Spp Risk Old- All (2024)")
```

### Output: `n_threat_raster_all.tif`
...
```{r}
n_threat_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/n_threat_raster_all.tif')

n_threat_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/n_threat_raster_all.tif')
...
plot(n_threat_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Threat New- All (2025)")
plot(n_threat_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Threat Old- All (2024)")
```

### Output: `trend_raster_all.tif`
...
```{r}
trend_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/trend_raster_all.tif')

trend_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/trend_raster_all.tif')
...
plot(trend_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "Trend New- All (2025)")
plot(trend_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "Trend Old- All (2024)")
```

### Output: `n_trend_raster_all.tif`
...
```{r}
n_trend_rast <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_output/n_trend_raster_all.tif')

n_trend_rast_old <- rast('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_output/n_trend_raster_all.tif')
...
plot(n_trend_rast, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Trend New- All (2025)")
plot(n_trend_rast_old, col = colors, zlim = c(0, max(max_old, max_new)), main = "N Trend Old- All (2024)")
```
