...
[SeaLifeBase search tool](https://www.sealifebase.se/search.php)
 ...
 [9] "Smalleyed squillid mantis shrimp" is in the data frame but the name got cut off in the species list to  "Smalleyed squillid mantis shri"
[12] "Ascidiaceans nei" are also in the data frame as "Ascidiaceans"
[16] "So-iny (redlip) mullet" has an entry that is "So-iuy mullet". Not sure if these are the same?
