...
table(pre_pandemic_dom$arrivals_method)
table(domestic_guests$arrivals_method)

nrow(pre_pandemic_dom)
colSums(is.na(pre_pandemic_dom))
...
mean_domestic_guests <- total_arrivals %>% 
  ...
  group_by(r2) %>% 
  mutate(
    # take the mean of arrivals by georegion
