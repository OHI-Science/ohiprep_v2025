...
**Issue:** There are Non-MPA Programs present in the WDPA polygons. For now, I've gone ahead and dropped these rows because each had <50 out of ~ 100K observations. 
...
shp_reorder_0 <- file.path(dir_data, 'shps_ho', 'WDPA_Jun2025_shp_ordered_0') # replace month and year with the appropriate month and year
