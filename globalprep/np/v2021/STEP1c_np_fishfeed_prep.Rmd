---
title: "OHI 2021: Natural Products, Preparing catch and B/Bmsy data for forage fish species"
...
Deleted the underharvest penalty for the FOFM bbmsy scores (and for FIS and AO bbmsy). Updated fisheries and RAM data.
...
old <- read_csv(here('globalprep/np/v2021/archive/np_fofm_scores.csv')) 
summary(old)
