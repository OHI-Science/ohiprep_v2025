---
title: "OHI 2021: Food Provision, Combining RAM and CMSY B/Bmsy data"
...
#341 stocks with RAM-B/Bmsy data (although RAM is matched by fao and rgns ids) - v2021
...
#702 stocks with CMSY-B/Bmsy data - v2021
```
...
# 704173 catch records (catch from specific fao and ohi regions) when joined with ram increases to 709529 because there are multiple stocks for some species - v2021

sum(!is.na(data$ram_bmsy))/nrow(data) # about 6% of catch records have RAM data - v2021
...
# 8028 regiosn with multiple RAM stocks (stockid_ram) for the same species 
