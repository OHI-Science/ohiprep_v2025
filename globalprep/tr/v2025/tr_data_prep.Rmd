...
```{r}
colnames(unwto_clean)
colSums(is.na(unwto_clean)) 
nrow(unwto_clean) # 6244
...
file_path_unwto_domestic_acc <- here::here(current_unwto_dir, "unwto-domestic-accommodation-data.xlsx")
...
```{r}
file_path_unwto_domestic_trips <- here::here(current_unwto_dir, "unwto-domestic-trips-data.xlsx")
