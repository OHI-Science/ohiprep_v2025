...
library(here);library(janitor);library("future");library(furrr);library(vroom);library(raster); library(tidyverse); library(terra)
...
n_years*n_crops == length(list.files("/home/shares/ohi/git-annex/globalprep/prs_land-based_nutrient/v2022/crop_stressors")) # TRUE
```
