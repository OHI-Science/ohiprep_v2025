...
shp_reorder_0 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_0') # replace month and year with the appropriate month and year
shp_reorder_1 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_1') # replace month and year with the appropriate month and year
shp_reorder_2 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_2') # replace month and year with the appropriate month and year
...
shp_reorder_0 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_0')
shp_reorder_1 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_1')
shp_reorder_2 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_2')
...
shp_xformed_0 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_xformed_0') # replace month and year with the appropriate month and year
shp_xformed_1 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_xformed_1') # replace month and year with the appropriate month and year
shp_xformed_2 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_xformed_2') # replace month and year with the appropriate month and year
...
shp_reorder_0 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_0') # we used May data in the 2024 update... sorry it's not as easy of a fix as the previous years where you could just change the last number!
shp_reorder_1 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_1')
shp_reorder_2 <- file.path(dir_data, 'shps', 'WDPA_Jun2025_shp_ordered_2')
