...
test_2022_int <- international_arrivals %>%
  ...
  mutate(tourism_ct_diff = (int_tourism_2022 - int_tourism_2020)/int_tourism_2020)

# global average increase for 2021 tourism_arrivals_ct
gf_2022_tourism_int <- mean(test_2022_int$tourism_ct_diff, na.rm = TRUE) 
gf_2022_tourism_int
# v2024: 0.1290837
...
total_population_wb <- read_csv(here(raw_data_dir, "WorldBank", current_data_dir, "WorldBank_global_country_population_1960-2023","API_SP.POP.TOTL_DS2_en_csv_v2_1584446.csv"), skip = 3) %>% 
...
Should be using "output", "rgn_area_inland1km.csv" and "rgn_area_offshore3nm.csv"
...
# 
# write_csv(tr_arrivals_props_tourism_gf, here::here(current_tr_dir, "out", "tr_arrivals_props_tourism_gf.csv"))
```
...
write_csv(tr_arrivals_props_tourism, here::here(current_tr_dir, "out", "tr_arrivals_props_tourism.csv"))
```
