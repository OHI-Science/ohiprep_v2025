---
title: "OHI 2021 - Pressure: Ultraviolet Radiation"
...
**Time Range**: Daily data from 2005 - 2020 (10/1/2004 through 08/10/2021, but only full years of data are used)
...
int_sp_data <- file.path(dir_M, "git-annex/globalprep/prs_uv/v2021/int") # intermediate spatial data location
out_dir <- file.path(dir_M, sprintf("git-annex/globalprep/prs_uv/v2021/output"))
...
file_list_raw <- read_delim(file.path("/home/shares/ohi/git-annex/globalprep/_raw_data/NASA_OMI_AURA_UV/d2021", "file_list.txt"), delim = "\\", col_names = FALSE)
...
resc_num  <- stats::quantile(vals, prob = 0.9999, na.rm = TRUE) # 42 for v2018; 46 for v2019, 49 for v2020, 47 for v2021
...
old <- uv_data %>% 
  filter(year == 2020) %>% # data years lag assessment yrs by 1
