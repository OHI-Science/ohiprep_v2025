...
cone_snails_24 <- read_csv(file.path('', 'taxa_summaries',
                                   sprintf('%s_cell_sum_comp_%s.csv', 'cone_snails',
...
```{r}
# Read in lots of data
spp_maps <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_data', sprintf('spp_marine_maps_%s.csv', '2024-1')),
                     col_types = 'ddcicccl') 

# Current global risk
spp_risk <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_data', sprintf('iucn_risk_current_%s.csv', '2024-1')), 
                     show_col_types = FALSE)

# Region info
spp_risk_rgn <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_data', sprintf('iucn_risk_rgn_current_%s.csv', '2024-1')),
                         col_types = 'dcccdc')

# Trend info
spp_trend_24 <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_data', sprintf('iucn_trend_by_spp_%s.csv', '2024-1')),
                      col_types = 'dc_d_')

spp_trend_22 <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2025/_data', sprintf('iucn_trend_by_spp_%s.csv', '2022-1')),
                      col_types = 'dc_d_')

# Range info and ocean area info
spp_range <- read_csv(file.path('/home/hoyt/OHI/ohiprep_v2025/globalprep/spp/v2024/_data',
                                sprintf('iucn_spp_range_area_%s.csv', '2024-1')),
                      col_types = 'dd__')

# Make a dataframe of species risk, trend, regional risk, and species range
spp_risk_trend_24 <- spp_risk %>%
  mutate(iucn_rgn = 'global') %>%
  bind_rows(spp_risk_rgn) %>%
  dplyr::select(iucn_sid, iucn_rgn, cat_score) %>%
  left_join(spp_trend, by = c('iucn_sid', 'iucn_rgn')) %>%
